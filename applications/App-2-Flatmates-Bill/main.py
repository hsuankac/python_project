...
print(f'{flatmate1.name} pays: ', flatmate1.pays(bill=the_bill, flatmate2=flatmate1))
print(f"{flatmate2.name} pays: ", flatmate2.pays(bill=the_bill, flatmate2=flatmate2))
