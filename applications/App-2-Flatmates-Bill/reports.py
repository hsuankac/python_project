...
class PdfReport:
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        pdf.cell(w=150, h=40, txt='March 2021', border=0, ln=1)
        ...
        # Change directory to where file is generated and open it
        os.chdir("files")
...
class FileSharer:
    ...
    def __init__(self, filepath, api_key='ALeKdFBkSwtf8m50MNJiwz'):
