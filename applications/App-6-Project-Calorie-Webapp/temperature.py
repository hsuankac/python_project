...
class Temperature:
    """A scraper that uses an yml file to read the xpath of a value it needs to extract from the
    ...
    # can only open in firefox to grab the xpath
    ...
    def get(self):
        ...
        return float(scrapped_content['temp'].replace("°F", "").strip())
