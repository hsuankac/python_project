...
# Go to tailwindcss to fine the command https://tailwindcss.com/docs
# If use Quasar, go to https://quasar.dev/vue-components/
...
def home():
    ...
    in_1 = jp.Input(a=div1, placeholder="Enter the first value", classes="form-input")
    in_2 = jp.Input(a=div1, placeholder="Enter the second value", classes="form-input")
    ...
    jp.Div(a=div2, text="I am a cool interactive div!",
           mouseenter=mouse_enter, mouseleave=mouse_leave, classes="hover:bg-red-500")
    return wp
